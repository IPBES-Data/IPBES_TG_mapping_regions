...
subtitle: Part 2 - Preparing and mapping data
date: today
author:
  - name: 
        family: Krug
...
citation:
  type: report
  container-title: " IPBES Technical Guidelines: Part 2 - Preparing and mapping data"
...
```{r}
#| label: download_faostat_population
...
```{r}
#| label: download_ipbes_shapefile
#| collapse: true
#| message: false
...
```{r}
#| label: read_faostat_and_shapefile
...
```{r}
#| label: remove_aggregated_records
...
```{r}
#| label: plot_regions_with_graticules
